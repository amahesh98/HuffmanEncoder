...
customTest:customTest.cpp HuffTree.o MinHeap.o TreeNode.o Encoder.o Decoder.o
	$(COMP) -g -o customTest MinHeap.o HuffTree.o Encoder.o Decoder.o TreeNode.o customTest.cpp
